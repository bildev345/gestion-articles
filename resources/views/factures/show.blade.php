...
<div class="invoice-header">
    ...
    <div class="invoice-meta">
        <div class="meta-grid">
            <span class="meta-label">Facture n°</span>
            ...
            <span class="meta-value">{{ $facture->client->id ?? '' }}</span>
        </div>

        <div class="client-block">
            <div class="client-title">
                {{ strtoupper($facture->client->nom) }}
            </div>
            @if($facture->client->adresse)
                <span class="client-sub">{{ $facture->client->adresse }}</span>
            @endif
...
<!-- ======== LABEL DEVISE ======== -->
<div class="facture-currency">Facture en MAD</div>
...
<table class="table-items">
    ...
    <tbody>
        @php $totalDetails = count($facture->details); $emptyRows = max(0, 5 - $totalDetails); @endphp
    ...
    <div style="width: 45%;">
        <div class="totals-box">
            ...
            <div class="total-row">
                ...
                <span class="t-value">
                    {{ $facture->mode_reglement ?? 'Manuelle' }}
                </span>
            </div>
           ...
           <div class="total-row">
            ...
            <div class="total-row">
                ...
                <span class="t-value">
                    {{ \App\Helpers\NumberToWords::convert($facture->total_ttc) }} Dirhams
                </span>
            </div>
...
<div class="no-print mt-5">
    <div class="card">
        ...
        <div class="card-body">
            <livewire:facture-paiement-manager :facture="$facture" />
        </div>
    </div>
</div>
