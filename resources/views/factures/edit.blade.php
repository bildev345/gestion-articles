            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 text-primary">
                        ...
                        Modifier Facture {{ $facture->numero ?? '#' . $facture->id }}
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="numero" class="form-control @error('numero') is-invalid @enderror" 
                                   value="{{ old('numero', $facture->numero) }}" required>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0" id="articlesTable">
                        ...
                        <tbody>
                            @forelse($facture->details as $index => $detail)
                            <tr>
                                <td>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('factures.show', $facture) }}" class="btn btn-outline-secondary">Annuler</a>
                    </div>
                </div>
            </div>
...
<script>
    ...
    let rowIndex = {{ count($facture->details ?? []) }};
