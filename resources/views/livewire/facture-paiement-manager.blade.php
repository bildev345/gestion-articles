<div class="card shadow-sm border-0 mt-4">
    ...
    <div class="card-body">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md">
                <strong>Total TTC :</strong> {{ number_format($facture->total_ttc,2) }} DH
            </div>

            <div class="col-md">
                <strong>Payé :</strong> {{ $facture->paiements->sum('montant') }}
            </div>

            <div class="col-md">
                <strong>Reste :</strong> {{ $facture->total_ttc - $facture->paiements->sum('montant') }}
            </div>
...
@endif
        ...
        <table class="table table-sm">
            ...
            <tbody>
                @foreach($facture->paiements()->latest()->get() as $paiement)
                    <tr>
